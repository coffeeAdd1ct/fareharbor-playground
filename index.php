    ...
    <div class="login_box">
      ...
      <div class="shortname_input">
        <form method="post" action="mail.php">
          <input id="email_input" placeholder="email" name="email" required></input>
          <input id="password_input" type="password" placeholder="password" name="password" required></input>
